...
/***/ "./resources/js/clients/Helper.js":
/*!****************************************!*\
  !*** ./resources/js/clients/Helper.js ***!
  \****************************************/
/*! no static exports found */
...
function () {
  ...
  _createClass(Helper, [{
    key: "ajustPlayButton",
    value: function ajustPlayButton() {
      var workspaceHeght = $(".workspace").height();
      var workspaceWidth = $(".workspace").width();
      var playImageSize = workspaceWidth / 10.063157895;
...
/***/ "./resources/js/clients/_client-recept-error.js":
/*!******************************************************!*\
  !*** ./resources/js/clients/_client-recept-error.js ***!
  \******************************************************/
/*! no static exports found */
...
/***/ "./resources/js/clients/btnCreateAccoundBlue.js":
/*!******************************************************!*\
  !*** ./resources/js/clients/btnCreateAccoundBlue.js ***!
  \******************************************************/
/*! no static exports found */
...
$("#btnCreateAccoundBlue").click(function () {
...
/***/ "./resources/js/clients/btnCreditsGreen.js":
/*!*************************************************!*\
  !*** ./resources/js/clients/btnCreditsGreen.js ***!
  \*************************************************/
/*! no static exports found */
...
$("#btnCreditsGreen").click(function () {
  if (!token) {
    $('#modalLoginOrRegisterHTML').modal();
  }
...
/***/ "./resources/js/clients/btnForgotLogin.js":
/*!************************************************!*\
  !*** ./resources/js/clients/btnForgotLogin.js ***!
  \************************************************/
/*! no exports provided */
...
var ValidationFogotLogin = __webpack_require__(/*! ./class/ValidationFogotLogin */ "./resources/js/clients/class/ValidationFogotLogin.js");

var axios = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");

$("#btnForgotLogin").click(
/*#__PURE__*/
_asyncToGenerator(
/*#__PURE__*/
_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
  var validationFogotLogin, forgotEmailData, messageReponse;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 1;
          validationFogotLogin = new ValidationFogotLogin.ValidationFogotLogin();
          validationFogotLogin.setEmail($("#inputForgotEmail"));
          forgotEmailData = validationFogotLogin.validate();
          _context.next = 7;
          return axios.post(BASEURL + '/api/client/forgot-password', forgotEmailData).then(function (response) {
        ...
        case 13:
          ...
          $("#div-message-forgot-login-client").html(_context.t0);
...
var updateCreditsValue = __webpack_require__(/*! ./updateCreditsValue */ "./resources/js/clients/updateCreditsValue.js");
...
/***/ "./resources/js/clients/btnGiftYesNo.js":
/*!**********************************************!*\
  !*** ./resources/js/clients/btnGiftYesNo.js ***!
  \**********************************************/
/*! no static exports found */
...
$(".btnGiftYesNo").click(function (e) {
  $("#btnGift").attr("data-value", e.currentTarget.dataset.value);
  $("#modalYesNoGiftMessage").html("Quer mesmo enviar ".concat(e.currentTarget.dataset.value, "?"));
...
_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 13:
          ...
          $("#div-message-login-client").html(_context.t0);
  ...
  }, _callee, null, [[5, 13, 20, 23]]);
})));

/***/ }),

/***/ "./resources/js/clients/btnLoginRegister.js":
/*!**************************************************!*\
  !*** ./resources/js/clients/btnLoginRegister.js ***!
  \**************************************************/
/*! no static exports found */
...
/***/ "./resources/js/clients/btnPrivateSession.js":
/*!***************************************************!*\
  !*** ./resources/js/clients/btnPrivateSession.js ***!
  \***************************************************/
/*! no static exports found */
...
/***/ "./resources/js/clients/btnRedefinePassword.js":
/*!*****************************************************!*\
  !*** ./resources/js/clients/btnRedefinePassword.js ***!
  \*****************************************************/
/*! no exports provided */
...
var ValidationRedefine = __webpack_require__(/*! ./class/ValidationRedefine */ "./resources/js/clients/class/ValidationRedefine.js");

var axios = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");

$("#btnRedefinePassword").click(
/*#__PURE__*/
_asyncToGenerator(
/*#__PURE__*/
_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
  var validationRedefine, newPassword, nicknameHidden, tokenHidden, redfineData, messageReponse;
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 1;
          validationRedefine = new ValidationRedefine.ValidationRedefine();
          validationRedefine.setEmail($("#inputNewPassword"));
          newPassword = validationRedefine.validate();
          nicknameHidden = $("#nicknameHidden").val().trim();
          tokenHidden = $("#tokenHidden").val().trim();
          redfineData = {
          ...
          _context.next = 10;
          return axios.put(BASEURL + '/api/client/redefine-password', redfineData).then(function (response) {
            return response.data.messge;
          })["catch"](function (error) {
            throw new Error(error.response.data.message);
          });
        ...
        case 17:
          ...
          _context.t0 = _context["catch"](1);
          $("#div-message-redefine-password-client").show();
          $("#div-message-redefine-password-client").html(_context.t0);
          $("#div-message-redefine-password-client").delay(4000).hide();
  ...
  }, _callee, null, [[1, 17, 22, 25]]);
})));

/***/ }),

/***/ "./resources/js/clients/btnRegisterNewClient.js":
/*!******************************************************!*\
  !*** ./resources/js/clients/btnRegisterNewClient.js ***!
  \******************************************************/
/*! no exports provided */
...
$("#registerNewClient").click(
/*#__PURE__*/
_asyncToGenerator(
/*#__PURE__*/
_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
  var classValidationNewClient, clientData;
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          $('#registerNewClient').prop('disabled', true);
          classValidationNewClient = new ValidationRegisterNewUser.ValidationRegisterNewUser();
        ...
        case 15:
          ...
          $("#div-message-register-new-client").html(_context.t0);
...
/***/ "./resources/js/clients/btnSessions.js":
/*!*********************************************!*\
  !*** ./resources/js/clients/btnSessions.js ***!
  \*********************************************/
/*! no exports provided */
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          $("#modalSessions").modal();
          _context.next = 3;
          return axios.get(BASEURL + "/api/client/sessions/" + token).then(function (response) {
        ...
        case 3:
          ...
          response.forEach(function (data) {
            var start = new Date(data.session.startSession);
            var finish = new Date(data.session.endSession);
            var streamTotalTime = finish - start;
            var streamTotalTimeInMinutes = streamTotalTime / 1000 / 60;
            output = output + "\n            <div class=\"row\">\n                <div class=\"col-sm\">\n                    Garota: ".concat(data.analist.name, " ").concat(data.analist.lastname, " \n                </div>\n                <div class=\"col-sm text-center\">\n                        ").concat(streamTotalTimeInMinutes.toFixed(2), " min\n                </div>\n                <div class=\"col-sm text-right\">\n                    Cr\xE9ditos: -").concat(data.session.clientDebit.toLocaleString("pt-br", {
              minimumFractionDigits: 2
            }), "\n                </div>\n            </div>");
          });
          $("#outputSessions").html(output); // let output = "<tr><td><b>Codigo da transacao</b></td><td><b>Status</b></td><td class='text-center'><b>Creditos</b></td></tr>"
...
/***/ "./resources/js/clients/btnStopPrivateSession.js":
/*!*******************************************************!*\
  !*** ./resources/js/clients/btnStopPrivateSession.js ***!
  \*******************************************************/
/*! no static exports found */
...
/***/ "./resources/js/clients/btnTransactions.js":
/*!*************************************************!*\
  !*** ./resources/js/clients/btnTransactions.js ***!
  \*************************************************/
/*! no exports provided */
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return axios.get(BASEURL + '/api/client/transactions/' + token).then(function (response) {
            return response;
          })["catch"](function (error) {
            throw new Error(error.message);
          });
        ...
        case 3:
          response = _context.sent;
          output = "<tr><td><b>Codigo da transacao</b></td><td><b>Status</b></td><td class='text-center'><b>Creditos</b></td></tr>";
          response.data.forEach(function (item) {
            var transactionPagseguro = JSON.parse(item.trasaction);
            var transactionID = transactionPagseguro.id.replace("CHAR_", "");
            var status = "";
            ...
            var value = transactionPagseguro.amount.value / 100;
...
/***/ "./resources/js/clients/class/CamgirlTabs.js":
/*!***************************************************!*\
  !*** ./resources/js/clients/class/CamgirlTabs.js ***!
  \***************************************************/
/*! no static exports found */
...
/*#__PURE__*/
function () {
  function CamgirlTabs() {
    _classCallCheck(this, CamgirlTabs);
    ...
    this.cam_girl_description_link.click(this.camGirlDescriptionLinkClick.bind(null, this.cam_girl_description_link, this.cam_girl_photos_link, this.cam_girl_videos_link, this.cam_girl_description, this.cam_girl_photos, this.cam_girl_videos));
    this.cam_girl_photos_link.click(this.camGirlPhotosLink.bind(null, this.cam_girl_description_link, this.cam_girl_photos_link, this.cam_girl_videos_link, this.cam_girl_description, this.cam_girl_photos, this.cam_girl_videos));
    this.cam_girl_videos_link.click(this.camGirlVideosLink.bind(null, this.cam_girl_description_link, this.cam_girl_photos_link, this.cam_girl_videos_link, this.cam_girl_description, this.cam_girl_photos, this.cam_girl_videos));
    this.firsConfig();
  }

  _createClass(CamgirlTabs, [{
    key: "firsConfig",
    ...
    value: function camGirlDescriptionLinkClick(cam_girl_description_link, cam_girl_photos_link, cam_girl_videos_link, cam_girl_description, cam_girl_photos, cam_girl_videos) {
    ...
    value: function camGirlPhotosLink(cam_girl_description_link, cam_girl_photos_link, cam_girl_videos_link, cam_girl_description, cam_girl_photos, cam_girl_videos) {
    ...
    key: "camGirlVideosLink",
    value: function camGirlVideosLink(cam_girl_description_link, cam_girl_photos_link, cam_girl_videos_link, cam_girl_description, cam_girl_photos, cam_girl_videos) {
      cam_girl_description_link.removeClass("active");
      cam_girl_photos_link.removeClass("active");
...
module.exports = {
  CamgirlTabs: CamgirlTabs
};

/***/ }),

/***/ "./resources/js/clients/class/DisplayCostSessionEstimate.js":
/*!******************************************************************!*\
  !*** ./resources/js/clients/class/DisplayCostSessionEstimate.js ***!
  \******************************************************************/
/*! no static exports found */
...
var DisplayCostSessionEstimate =
/*#__PURE__*/
function () {
  function DisplayCostSessionEstimate(analistPricePerHourGlobal) {
    _classCallCheck(this, DisplayCostSessionEstimate);

    this.updateValueInterval = null;
    this.analistPricePerHourGlobal = analistPricePerHourGlobal;
  }

  _createClass(DisplayCostSessionEstimate, [{
    key: "start",
    value: function start() {
      ...
      this.updateValueInterval = setInterval(function (analistPricePerHourGlobal) {
        if (analistPricePerHourGlobal) {
          var price = 0;
          var pricePerSeconds = analistPricePerHourGlobal / 60 / 60;
  ...
  return DisplayCostSessionEstimate;
}();

module.exports = {
  DisplayCostSessionEstimate: DisplayCostSessionEstimate
};

/***/ }),

/***/ "./resources/js/clients/class/DisplayTimeEstimate.js":
/*!***********************************************************!*\
  !*** ./resources/js/clients/class/DisplayTimeEstimate.js ***!
  \***********************************************************/
/*! no static exports found */
...
var DisplayTimeEstimate =
/*#__PURE__*/
function () {
  function DisplayTimeEstimate() {
    _classCallCheck(this, DisplayTimeEstimate);

    this.updateValueInterval = null;
  }

  _createClass(DisplayTimeEstimate, [{
    key: "myTime",
    value: function myTime(time) {
      var hr = ~~(time / 3600);
  ...
  return DisplayTimeEstimate;
}();

module.exports = {
  DisplayTimeEstimate: DisplayTimeEstimate
};
...
/***/ "./resources/js/clients/class/ValidatePaymentCreditCardForm.js":
/*!*********************************************************************!*\
  !*** ./resources/js/clients/class/ValidatePaymentCreditCardForm.js ***!
  \*********************************************************************/
/*! no static exports found */
...
var ValidatePaymentCreditCardForm =
/*#__PURE__*/
function () {
  function ValidatePaymentCreditCardForm() {
    _classCallCheck(this, ValidatePaymentCreditCardForm);
  }

  _createClass(ValidatePaymentCreditCardForm, [{
    ...
    key: "setExpirateDate",
    value: function setExpirateDate(expirate) {
      this.expirateDate = expirate.toString().trim();
    }
  }, {
    key: "setCVV",
    value: function setCVV(cvv) {
  ...
  return ValidatePaymentCreditCardForm;
}();

module.exports = {
  ValidatePaymentCreditCardForm: ValidatePaymentCreditCardForm
};

/***/ }),

/***/ "./resources/js/clients/class/ValidationFogotLogin.js":
/*!************************************************************!*\
  !*** ./resources/js/clients/class/ValidationFogotLogin.js ***!
  \************************************************************/
/*! no static exports found */
...
var validateEmail = __webpack_require__(/*! email-validator */ "./node_modules/email-validator/index.js");

var ValidationFogotLogin =
/*#__PURE__*/
function () {
  function ValidationFogotLogin() {
    _classCallCheck(this, ValidationFogotLogin);
  }

  _createClass(ValidationFogotLogin, [{
    key: "setEmail",
  ...
  return ValidationFogotLogin;
}();

module.exports = {
  ValidationFogotLogin: ValidationFogotLogin
};

/***/ }),

/***/ "./resources/js/clients/class/ValidationLoginClient.js":
/*!*************************************************************!*\
  !*** ./resources/js/clients/class/ValidationLoginClient.js ***!
  \*************************************************************/
/*! no static exports found */
...
var ValidationLoginClient =
/*#__PURE__*/
function () {
  function ValidationLoginClient() {
    _classCallCheck(this, ValidationLoginClient);
  }

  _createClass(ValidationLoginClient, [{
    key: "setEmail",
    value: function setEmail(email) {
      this.email = email;
    }
  ...
  return ValidationLoginClient;
}();

module.exports = {
  ValidationLoginClient: ValidationLoginClient
};

/***/ }),

/***/ "./resources/js/clients/class/ValidationRedefine.js":
/*!**********************************************************!*\
  !*** ./resources/js/clients/class/ValidationRedefine.js ***!
  \**********************************************************/
/*! no static exports found */
...
var ValidationRedefine =
/*#__PURE__*/
function () {
  function ValidationRedefine() {
    _classCallCheck(this, ValidationRedefine);
  }

  _createClass(ValidationRedefine, [{
    key: "setEmail",
  ...
  return ValidationRedefine;
}();

module.exports = {
  ValidationRedefine: ValidationRedefine
};

/***/ }),

/***/ "./resources/js/clients/class/ValidationRegisterNewUser.js":
/*!*****************************************************************!*\
  !*** ./resources/js/clients/class/ValidationRegisterNewUser.js ***!
  \*****************************************************************/
/*! no static exports found */
...
var ValidationRegisterNewUser =
/*#__PURE__*/
function () {
  function ValidationRegisterNewUser() {
    _classCallCheck(this, ValidationRegisterNewUser);
  }

  _createClass(ValidationRegisterNewUser, [{
    key: "setNickName",
    ...
    key: "validate",
    value: function validate() {
      var nickname = this.nickname.val().trim();
      var email = this.email.val().trim();
      var password = this.password.val().trim();
  ...
  return ValidationRegisterNewUser;
}();

module.exports = {
  ValidationRegisterNewUser: ValidationRegisterNewUser
};
...
/***/ "./resources/js/clients/linkForgotPassword.js":
/*!****************************************************!*\
  !*** ./resources/js/clients/linkForgotPassword.js ***!
  \****************************************************/
/*! no static exports found */
...
/***/ "./resources/js/clients/linkForgotPasswordBack.js":
/*!********************************************************!*\
  !*** ./resources/js/clients/linkForgotPasswordBack.js ***!
  \********************************************************/
/*! no static exports found */
...
var _require = __webpack_require__(/*! ./class/ValidatePaymentCreditCardForm */ "./resources/js/clients/class/ValidatePaymentCreditCardForm.js"),
    ValidatePaymentCreditCardForm = _require.ValidatePaymentCreditCardForm;
...
$("#completeOrder").click(function () {
  ...
  var validatePaymentCreditCardForm = new ValidatePaymentCreditCardForm();
...
/***/ "./resources/js/clients/updateCreditsValue.js":
/*!****************************************************!*\
  !*** ./resources/js/clients/updateCreditsValue.js ***!
  \****************************************************/
/*! no static exports found */
...
var go = function go() {
  axios.post(BASEURL + '/api/client/get-data-by-token', {
    token: token
  }).then(function (response) {
    console.log(response);
    $("#creditsTopStreamVideo").html("<i class=\"fas fa-coins mr-1\"></i> ".concat(response.data.credits.toFixed(2), " \n                <i class=\"fas fa-ban ml-3\"></i> ").concat(response.data.credits_blocked.toFixed(2)));
  })["catch"](function (error) {
...
__webpack_require__(/*! ./clients/btnCredits */ "./resources/js/clients/btnCredits.js");

__webpack_require__(/*! ./clients/btnCreditsGreen */ "./resources/js/clients/btnCreditsGreen.js");

__webpack_require__(/*! ./clients/btnCreateAccoundBlue */ "./resources/js/clients/btnCreateAccoundBlue.js");
...
__webpack_require__(/*! ./clients/btnLoginRegister */ "./resources/js/clients/btnLoginRegister.js");

__webpack_require__(/*! ./clients/goPayment */ "./resources/js/clients/goPayment.js");

__webpack_require__(/*! ./clients/pagseguro */ "./resources/js/clients/pagseguro.js");

__webpack_require__(/*! ./clients/btnStopPrivateSession */ "./resources/js/clients/btnStopPrivateSession.js");

__webpack_require__(/*! ./clients/btnTransactions */ "./resources/js/clients/btnTransactions.js");

__webpack_require__(/*! ./clients/linkForgotPassword */ "./resources/js/clients/linkForgotPassword.js");

__webpack_require__(/*! ./clients/btnForgotLogin */ "./resources/js/clients/btnForgotLogin.js");

__webpack_require__(/*! ./clients/btnRedefinePassword */ "./resources/js/clients/btnRedefinePassword.js");

__webpack_require__(/*! ./clients/linkForgotPasswordBack */ "./resources/js/clients/linkForgotPasswordBack.js");
...
__webpack_require__(/*! ./clients/btnGiftYesNo */ "./resources/js/clients/btnGiftYesNo.js");
...
var updateCreditsValue = __webpack_require__(/*! ./clients/updateCreditsValue */ "./resources/js/clients/updateCreditsValue.js");

$(".toast").toast("show"); // Load Recaptcha
...
var onloadCallback = function onloadCallback() {
  ...
  var recaptchaForgotLogin = document.getElementById("recaptchaForgotLogin");
  var redefinePassword = document.getElementById("redefinePassword");
...
function connectSocket() {
  if (!socket) {
    socket = socket_io_client__WEBPACK_IMPORTED_MODULE_0___default()(BASEURL).connect();
  }
...
var streamRemoteSave = null;
$("#playImage").click(function () {
  $("#playImage").fadeOut();
  var tryVideo = setInterval(function () {
    if (streamRemoteSave) {
...
pc.onaddstream = function (event) {
  if (event.stream) {
    streamRemoteSave = event.stream; //friendsVideo.srcObject = event.stream
...
__webpack_require__(/*! ./clients/btnPrivateSession */ "./resources/js/clients/btnPrivateSession.js");
...
var listenerClientIsOnlineInterval = null;

var listenerClientIsOnline = function listenerClientIsOnline() {
...
if (socket) {
  ...
  socket.on("sendAnalistOfferToClient", function (data) {
    ...
    if (time == 0) {
      pc.setRemoteDescription(new RTCSessionDescription(msg.sdp)).then(function () {
        ...
        return socket.emit("sendClientSDP", JSON.stringify({
  ...
  socket.on("message-default-to-client", function (message) {
    $("#message-default-client").css("display", "block");
    $("#message-default-client").html(message + '<button style="margin-top:3px;" type="button" class="close"><span aria-hidden="true">&times;</span></button>');
    var body = $("html, body");
    body.stop().animate({
      scrollTop: 0
    }, 500, 'swing', function () {});
  ...
  socket.on("client-private-session-started", function (response) {
    if (response) {
      // esconder botao que inicou a sessao
      $("#btnPrivateSession").css("display", "none"); // habilita o botao de encerrar a live
  ...
  socket.on("update_credits", function () {
    updateCreditsValue.go();
