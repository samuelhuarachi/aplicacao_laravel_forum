...
var updateCreditsValue = __webpack_require__(/*! ./clients/updateCreditsValue */ "./resources/js/clients/updateCreditsValue.js"); //const { ConfigureIsOnline } = require('./common')
...
pc.onicecandidate = function (event) {
  if (event.candidate) {//iceList.push(event.candidate)
...
socket.on("message-default-to-client", function (message) {
  $("#message-default-client").css("display", "block");
  $("#message-default-client").html(message + '<button type="button" class="close"><span aria-hidden="true">&times;</span></button>'); //$("#message-default-client").alert()
});
