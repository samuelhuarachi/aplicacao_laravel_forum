...
/***/ "./resources/js/analist/DisplayCostSessionEstimate.js":
/*!************************************************************!*\
  !*** ./resources/js/analist/DisplayCostSessionEstimate.js ***!
  \************************************************************/
/*! no static exports found */
...
/***/ "./resources/js/analist/alertNewClientsInRoom.js":
/*!*******************************************************!*\
  !*** ./resources/js/analist/alertNewClientsInRoom.js ***!
  \*******************************************************/
/*! no static exports found */
...
var alertNewClientInRoom = function alertNewClientInRoom() {
  var alertSound = document.getElementById("alertNewClients");
  alertSound.pause();
  alertSound.play();
};
...
$('#btnShowSessionsMenu').click(
/*#__PURE__*/
_asyncToGenerator(
/*#__PURE__*/
_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
  var response, output, totalGains;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          $("#modalSessions").modal();
          _context.next = 3;
          return axios.get(BASEURL + "/api/analist/sessions", {
            headers: {
        ...
        case 3:
          ...
          response.forEach(function (data) {
            ...
            output = output + "\n            <div class=\"row\">\n                <div class=\"col-sm\">\n                    ".concat(data.client.nickname, "\n                </div>\n                <div class=\"col-sm text-center\">\n                        ").concat(streamTotalTimeInMinutes.toFixed(2), " min\n                </div>\n                <div class=\"col-sm text-right\">\n                    +").concat(data.session.analistGains.toLocaleString("pt-br", {
              minimumFractionDigits: 2
            }), " <i class=\"fas fa-coins\"></i>\n                </div>\n            </div>");
            totalGains = totalGains + data.session.analistGains;
          });
          $("#modalSessionTotalGains").html(totalGains.toLocaleString("pt-br", {
            minimumFractionDigits: 2
          }));
...
/***/ "./resources/js/analist/btnStopPrivateSession.js":
/*!*******************************************************!*\
  !*** ./resources/js/analist/btnStopPrivateSession.js ***!
  \*******************************************************/
/*! no static exports found */
...
var gainstUpdate = function gainstUpdate() {
  axios.get(BASEURL + '/api/analist/get-data', {
    headers: {
      Authorization: "Bearer " + token
    }
  }).then(function (response) {
...
/***/ "./resources/js/analist/listOfClientsActiveInYourChatFunction.js":
/*!***********************************************************************!*\
  !*** ./resources/js/analist/listOfClientsActiveInYourChatFunction.js ***!
  \***********************************************************************/
/*! no static exports found */
...
var listOfClientsActiveInYourChatFunction = function listOfClientsActiveInYourChatFunction(listActiveClients) {
  var htmlRender = '';
  listActiveClients.forEach(function (client) {
    var loggedInfo = "Visitante";
    var credits = 0;
    var logged = client.logged;
...
/***/ "./resources/js/analist/showQuantityOnlineClients.js":
/*!***********************************************************!*\
  !*** ./resources/js/analist/showQuantityOnlineClients.js ***!
  \***********************************************************/
/*! no static exports found */
...
var showQuantityOnlineClients = function showQuantityOnlineClients(listActiveClients) {
  $("#socketOnlineClients").html("Usuários online: " + listActiveClients.length.toString());
};

module.exports = {
  showQuantityOnlineClients: showQuantityOnlineClients
};
...
__webpack_require__(/*! ./analist/btnStopPrivateSession */ "./resources/js/analist/btnStopPrivateSession.js");
...
var alertNewClientInRoom = __webpack_require__(/*! ./analist/alertNewClientsInRoom */ "./resources/js/analist/alertNewClientsInRoom.js");

var gainstUpdate = __webpack_require__(/*! ./analist/gainstUpdate */ "./resources/js/analist/gainstUpdate.js");

var DisplayCostSessionEstimate = __webpack_require__(/*! ./analist/DisplayCostSessionEstimate */ "./resources/js/analist/DisplayCostSessionEstimate.js");
...
var myConnections = [];
var saveActiveStream = null; // navigator.getUserMedia =
...
var listenerAnalistIsOnlineInterval = null;

var listenerAnalistIsOnline = function listenerAnalistIsOnline() {
...
function disconnectAllFromPrivateSession(clientSocketIDRequestedPrivate) {
  var keysInMyconnections = Object.keys(myConnections);
...
socket.on("client-request-stop-session", function () {
...
socket.on("analist-stop-session", function () {
  $("#btnStopPrivateSession").css("display", "none");
  $("#private-session-message").css("display", "none");
  clearInterval(listenerAnalistIsOnlineInterval);
  gainstUpdate.gainstUpdate();
...
socket.on("update_gains", function () {
  gainstUpdate.gainstUpdate();
...
socket.on("receiveClientICE", function (data) {
  ...
  var pc = myConnections[data.clientId];
...
socket.on("generateAnalistOffer", function (clientId) {
  ...
  if (pc) {
    console.log("putzz achei um pc aqui"); //disconnectPeerByClientSocketID(clientId)
  }
  ...
  pc.onicecandidate = function (event) {
    ...
    } else {//console.log("Sent all Analist ice")
    }
  };

  pc.addStream(saveActiveStream); // saveActiveStream.getTracks().forEach(
  //     track => {
...
$("#btnSend").click(function () {
  ...
  if (message != "") {
    var history = $("#history-messages").html();
    history = history + '<br><b class="analistHistory">' + analistName + " " + analistLastname + ":</b> " + escapeHtml(message);
    $("#history-messages").html(history);
    $("#history-messages").animate({
      scrollTop: 9999
    }, "slow");
...
function connectSocket() {
  if (!socket) {
    socket = socket_io_client__WEBPACK_IMPORTED_MODULE_1___default()(BASEURL).connect();
  }

  socket.on("connect", function () {
    var analistID = socket.id;
    /**
     * isso daqui eh bom mudar
     * enviar o token do analita, e registrar
     */

    socket.emit("registerAnalist", JSON.stringify({
      id: analistID,
      slug: slug
    }));
  });
